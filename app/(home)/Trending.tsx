  ...
  return (
    <section className="pt-3 pb-10 ">
      ...
      <div className="sm:grid grid-cols-4 gap-5 grid-rows-2 sm:h-[600px] my-3">
        <TrendingCard className=" col-span-2 row-span-2 border" post = {trendingPosts[0]}/>
        <TrendingCard className=" col-span-2 row-span-1 border" post = {trendingPosts[1]}/>
        <TrendingCard className=" col-span-1 row-span-1 border" post = {trendingPosts[2]}/>
        <TrendingCard className=" col-span-1 row-span-1 border" post = {trendingPosts[3]}/>
      </div>
      <p className="text-sm">
